    ...
    <!-- Book show -->
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="width:15%;font-size: 1.6rem;float: left;"><i class="far fa-address-card text-light fa-1x mr-3 text-dark mr-3"></i><strong class="pt-5">About</strong></h3><br>
        <hr>
        </div>
