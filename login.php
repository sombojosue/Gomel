  ...
  <main id="login">
    ...
    <section id="login_section">
      ...
      <div class="form-group " id="paddingtop">
        ...
        <form method="post">
          <input type="email" name="email" autofocus class="form-control mb-2" placeholder="Email">
          <input type="password" name="password" class="form-control mb-2" placeholder="Password">
          <input type="checkbox" name="keep" class="" checked><span style="position: relative;top: -2px;" class="text-justify">&nbsp;&nbsp;Remember username</span>
          <input type="submit" name="login" value="Login" class="btn btn-warning text-white w-100">
        </form>
      </div>
      </div>
    </section>
